...
The assets resource lets you list and get assets for the current tenant, create, update, and delete assets. Set tenant context before calling these methods. {{ className: 'lead' }}
