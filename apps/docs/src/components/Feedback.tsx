...
>(function FeedbackThanks({ className, ...props }, ref) {
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full bg-primary-50/50 py-1 pr-3 pl-1.5 text-sm text-primary-900 ring-1 ring-primary-500/20 ring-inset dark:bg-primary-500/5 dark:text-primary-200 dark:ring-primary-500/30">
