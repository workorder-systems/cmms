...
<Note>
  **HTTP MCP clients:** after calling <code>set_active_tenant</code>, send
  <code>X-Supabase-Refresh-Token</code> with the Supabase <code>refresh_token</code>
