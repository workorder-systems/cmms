...
Build an optional extension or integration on top of the Work Order Systems API. Plugins are separate services or UIs that call the public API—they don't change the database schema. {{ className: 'lead' }}
