...
Under the hood, these flows now align more closely with shared SDK ergonomics:

- `client.workOrders.listSummary(...)`
- `client.assets.listSummary(...)`
- `client.partsInventory.listSummary(...)`
- `client.pm.listSchedulesSummary(...)`
- `client.agent.resolveTenant()`
- `client.agent.ensureTenant(...)`
- `client.agent.createWorkOrderSafe(...)`
