...
export const Route = createFileRoute('/_protected/dashboard/team/departments/import')({
  beforeLoad: async ({ context }) => ensureTenantContext(context),
  component: TeamDepartmentsImportPage,
})

function TeamDepartmentsImportPage() {
  ...
  const onImport = React.useCallback(
    async (
      ...
      if (ok > 0) navigate({ to: '/dashboard/team/departments' })
    },
