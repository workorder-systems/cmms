...
export const Route = createFileRoute('/_protected/dashboard/team/departments')({
  component: TeamDepartmentsPage,
})

function TeamDepartmentsPage() {
      ...
      <ExtensionPoint name="header.right">
        <div className="flex items-center gap-2">
          <Button asChild size="sm" variant="ghost">
            <Link to="/dashboard/team/departments/import">
