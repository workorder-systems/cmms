# WorkOrder Systems — project & adoption

Long-form context for **vision**, **alpha expectations**, **stability**, **license**, and **OSS vs commercial** boundaries. The root [README](../README.md) stays short; deep detail lives here.
...
| **`apps/supabase/functions/`** | Edge Functions (e.g. meter ingest); same AGPL license as the rest of the tree unless a file header states otherwise. |
...
- `apps/supabase/` — Supabase CLI project: migrations, `config.toml`, Edge Functions
- `apps/docs/` — Next.js documentation site for the public API
- `packages/sdk/` — **`@workorder-systems/sdk`**
- `plugins/example/` — Webhook receiver for plugin smoke tests
- `tests/` — Vitest integration tests
- `docs/` — ADRs, client flows, this file

## Further reading

- [Database architecture](../apps/supabase/README.md)
- [AGENTS.md](../AGENTS.md) — automation / agent playbook
